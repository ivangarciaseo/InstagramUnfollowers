...
export const DEFAULT_MIN_FOLLOWERS = 0;
export const DEFAULT_MAX_FOLLOWERS = 0; // 0 = no limit
export const TIME_BETWEEN_PROFILE_FETCHES = 1500; // ms between each profile info request
